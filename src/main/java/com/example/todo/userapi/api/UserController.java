...
//        log.info("email: {}", dto.getEmail());
    ...
    public ResponseEntity<?> loadFile(
        ...
        try {
            ...
            MediaType contentType = findExtensionsAndGetMediaType(filePath);
            if(contentType == null) {
                return ResponseEntity.internalServerError()
    ...
    private MediaType findExtensionsAndGetMediaType(String filePath) {

        // 파일 경로에서 확장자 추출하기
        // C:/todo_upload/sdfsdfdsf/.abc.jpg
        String ext
    ...
    public ResponseEntity<?> logout(
        ...
        //  카카오 로그이을 했던 사람은 id가 들어있고 그렇지 않은 사람은 null이 들어있다.
