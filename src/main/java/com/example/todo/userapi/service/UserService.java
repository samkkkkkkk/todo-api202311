...
public class UserService {
    ...
    /**
     * 업로드 된 파일을 서버에 저장하고 저장 경로를 리텅.
     *
     * @param profileImg - 업로드 된 파일의 정보
     * @return 실제로 저장된 이미지 경로
     */
    public String uploadProfileImage(MultipartFile profileImg) throws Exception{

        // 루티 디렉토리가 실존하는 지 확인 후 존재하지 않으면 생성.
    ...
    public String findProfilePath(String userId) {
        ...
        // DB에 저장되는 profile_img는 파잉명 -> service가 가지고 있는 Root Path와 연결해서 리턴.
